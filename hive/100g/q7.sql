...
from (
  select supp_nation, cust_nation, substr(l_shipdate, 1, 4) as l_year,
...
(select l_shipdate, l_extendedprice, l_discount, c_nationkey,
s_nationkey
from supplier s join
(select l_shipdate, l_extendedprice, l_discount, l_suppkey,
c_nationkey
...
) l3 on l3.c_nationkey = t.c_nationkey
and l3.s_nationkey = t.s_nationkey
) shipping
